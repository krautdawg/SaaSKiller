...
const QuoteGenerator = () => {
  ...
  return (
    <div className="p-6 rounded-xl border bg-teal-50 border-teal-200 relative overflow-hidden shadow-[0_4px_12px_rgba(0,0,0,0.05)]">
       ...
       <h3 className="text-lg font-bold mb-2 uppercase tracking-widest text-teal-800 font-heading">{t('quote.title')}</h3>
       <div className="flex justify-between items-end mb-2">
          ...
          <div className="text-sm font-bold mb-2 bg-yellow-300 px-2 py-1 rounded text-yellow-900 font-sans">{t('quote.oneTime')}</div>
       </div>
       <p className="text-sm text-gray-600 mb-3 font-sans">
         {t('quote.includes', activeFeaturesCount, customFeatures.length)}
       </p>
